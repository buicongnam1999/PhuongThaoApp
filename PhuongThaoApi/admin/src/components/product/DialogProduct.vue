                    ...
                    <form action="">
                        <div class="form-element">
                            <div class="element-left">
                                <div><label for="">Tên sản phẩm(*) <i style="color: red"></i></label></div>
                                <div>
                            ...
                            <div class="element-right">
                                <div><label for="">Mã sản phẩm(*)</label><i style="color: red"></i></div>
                                <div class="dialog-input" style="margin-top: 10px">
                        ...
                        <div class="form-element"  style="margin-top: 15px;">
                            <div class="element-left">
                                <div><label for="">Giá sản phẩm(*)</label><i style="color: red"></i></div>
                                <div class="dialog-input" style="margin-top: 10px">
                                    <input type="text" name="txtAssetNam" v-model="employee.u_name">
                                </div>
                            </div>
                        ...
                        <div class="form-element" style="margin-top: 15px">
                            <div class="element-left">
                                <div><label for="">Kiểu sản phẩm<i style="color: red"></i></label></div>
                                <div  class="dialog-input" style="margin-top: 10px">
                            ...
                            <div class="element-right">
                                <div><label for="">Miêu tả</label></div>
                                <div  class="dialog-input"  style="margin-top: 10px">
                        ...
                        <div class="footer-form">
                            ...
                            <div class="footer-form-right">
                                <div class="btn-add" @click="create">Lưu</div>
                            </div>
                        </div>
                    </form>
                </div>
